...
public final class Farsi
{
	...
	private final static String	szLa					= Character
																.toString((char) 0xfefb);			// La
	private final static String	szLaStick				= Character
																.toString((char) 0xfefc);			// La
																									// (Sticky!!!)
	...
	{
		return (ch >= (char) 65 & ch <= (char) 122) | Character.isDigit(ch);
	}
